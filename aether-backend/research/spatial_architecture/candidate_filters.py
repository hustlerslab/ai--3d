"""Compatibility shim. `candidate_filters` was migrated to `app.planning.candidate_filters` in the
...
import app.planning.candidate_filters as _canonical  # noqa: E402
