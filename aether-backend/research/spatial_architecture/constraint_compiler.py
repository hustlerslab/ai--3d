"""Compatibility shim. `constraint_compiler` was migrated to `app.planning.constraint_compiler` in the
...
import app.planning.constraint_compiler as _canonical  # noqa: E402
