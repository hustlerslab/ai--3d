"""Compatibility shim. `candidate_generators` was migrated to `app.planning.candidate_generators` in the
...
import app.planning.candidate_generators as _canonical  # noqa: E402
