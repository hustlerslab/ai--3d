"""Compatibility shim. `scene_serialization` was migrated to `app.spatial.scene_serialization` in the
...
import app.spatial.scene_serialization as _canonical  # noqa: E402
